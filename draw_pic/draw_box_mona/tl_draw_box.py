...
def draw_perce_box(perce_json_src,pic_src,dst):
    ...
    # with open(perce_json_src,'r') as f2:    
        ...
        proportion_h = 3
        proportion_z = 3
        if  perce_json_data[4]['front_far_traffic_light']["detect_result"]:
            for each in perce_json_data[4]["front_far_traffic_light"]["detect_result"]:
...
for root,_,files in os.walk('/home/lixialin/Downloads/temp'):
    for file_ in files:
        perce_json_src = os.path.join(root,file_)
        pic_path = root.replace('/home/lixialin/Downloads/temp','/media/lixialin/b4228689-0850-4159-ad34-8eaba32c783d/00_dataset/TL/3840x2160_jpg_rename')
